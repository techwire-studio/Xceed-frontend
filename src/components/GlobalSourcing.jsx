...
const GlobalSourcingComponent = () => {
  return (
    <div className="max-w-[1440px] bg-gray-100 pt-8 lg:pt-8 md:pb-64 lg:pb-40 relative mr-0 font-jost px-4 lg:px-8">
      {/* Two different layouts based on screen size */}
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black w-full lg:w-[400px] mb-8 lg:mb-12 text-center lg:text-left">
        ...
        <div className="hidden lg:flex lg:gap-2">
          <div className="relative w-[210px] h-[450px] overflow-hidden z-10"> 
            <img src={taiwan} alt="Taiwan Lab" className="w-[400px] h-full object-cover" />
            <div className="absolute inset-0 bg-[rgba(26,43,60,0.5)]"></div>
            <span className="absolute bottom-5 left-1/2 transform -translate-x-1/2 text-2xl font-bold text-white z-20">
              Taiwan
            </span>
            <div className='absolute bottom-4.5 left-7/12 transform -translate-x-1/2 w-16 h-1 bg-yellow-500 z-1000'></div>
          </div>
          <div className="relative w-[210px] h-[450px] overflow-hidden z-10"> 
      ...
      {/* Bottom green banner - responsive for all screens */}
      <div className="md:absolute bottom-0 left-0 w-full px-4 md:px-8 lg:px-12 py-6 lg:py-10 bg-[#6BB356] flex flex-col lg:flex-row z-0 mt-2">
        ...
        <div className="lg:ml-auto self-center lg:self-end mt-6 lg:mt-0">
